...
class Calculation(models.Model):
    ...
    # shares:
    father_share = models.FloatField(default=0.0)
    mother_share = models.FloatField(default=0.0)
    son_share = models.FloatField(default=0.0)
    daughter_share = models.FloatField(default=0.0)
    brother_share = models.FloatField(default=0.0)
    brother_from_mother_share = models.FloatField(default=0.0)
    sister_from_mother_share = models.FloatField(default=0.0)
    sister_from_father_share = models.FloatField(default=0.0)
    brother_from_father_share = models.FloatField(default=0.0)
    sister_share = models.FloatField(default=0.0)
    hamsar_share = models.FloatField(default=0.0)
    bro_of_dad_share = models.FloatField(default=0.0)
    sis_of_dad_share = models.FloatField(default=0.0)
    bro_of_mom_share = models.FloatField(default=0.0)
    sis_of_mom_share = models.FloatField(default=0.0)
    father_of_father_share = models.FloatField(default=0.0)
    mother_of_father_share = models.FloatField(default=0.0)
    father_of_mother_share = models.FloatField(default=0.0)
    mother_of_mother_share = models.FloatField(default=0.0)
