...
class Calculation(models.Model):
    ...
    father_share = models.PositiveSmallIntegerField(default=0)
    mother_share = models.PositiveSmallIntegerField(default=0)
    son_share = models.PositiveSmallIntegerField(default=0)
    daughter_share = models.PositiveSmallIntegerField(default=0)
    brother_share = models.PositiveSmallIntegerField(default=0)
    sister_share = models.PositiveSmallIntegerField(default=0)
    hamsar_share = models.PositiveSmallIntegerField(default=0)
    bro_of_dad_share = models.PositiveSmallIntegerField(default=0)
    sis_of_dad_share = models.PositiveSmallIntegerField(default=0)
    bro_of_mom_share = models.PositiveSmallIntegerField(default=0)
    sis_of_mom_share = models.PositiveSmallIntegerField(default=0)
